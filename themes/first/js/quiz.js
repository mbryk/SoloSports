...
(function (aw, aA) {
    ...
    (function () {
        ...
        S.getText=function(a7){
            for(var a6="",a8,a5=0;a7[a5];a5++){
                ...
                if(a8.nodeType===3||a8.nodeType===4){
                    ...
                    if(a8.nodeType!==8){a6+=S.getText(a8.childNodes)}
                }
            }
            return a6
        };
        (function(){
            var a6=H.createElement("div"),a5="script"+(new Date).getTime(),a7=H.documentElement;
            ...
            if(H.getElementById(a5)){
                E.find.ID=function(a8,ba,a9){
                    if(typeof ba.getElementById!=="undefined"&&!a9){
                        return(ba=ba.getElementById(a8[1]))
                            ?ba.id===a8[1]||typeof ba.getAttributeNode!=="undefined"&&ba.getAttributeNode("id").nodeValue===a8[1]
                                ?[ba]
                                :aA
                            :[]
                    }
        ...
        H.querySelectorAll&&function(){
            var a6=S,a5=H.createElement("div");
            ...
            if(!(a5.querySelectorAll&&a5.querySelectorAll(".TEST").length===0)){
                S=function(a8,bc,bb,a9){
                    ...
                    if(!a9&&!S.isXML(bc)){
                        if(bc.nodeType===9){
                            try{return t(bc.querySelectorAll(a8),bb)}
                            catch(bf){}
                        }
                        else{
                            if(bc.nodeType===1&&bc.nodeName.toLowerCase()!=="object"){
                                var ba=bc.getAttribute("id"),be=ba||"__sizzle__";
                                ba||bc.setAttribute("id",be);
                                try{return t(bc.querySelectorAll("#"+be+" "+a8),bb)}
                                catch(bd){}
                                finally{ba||bc.removeAttribute("id")}
                            }
                        }
                    }
        ...
        (function(){
            var a7=H.documentElement,a6=a7.matchesSelector||a7.mozMatchesSelector||a7.webkitMatchesSelector||a7.msMatchesSelector,a8=false;
            ...
            if(a6){
                S.matchesSelector=function(bb,ba){
                    ...
                    if(!S.isXML(bb)){
                        try{if(a8||!E.match.PSEUDO.test(ba)&&!/!=/.test(ba)){return a6.call(bb,ba)}}
                        catch(a9){}
                    }
        ...
        S.contains=H.documentElement.contains
            ?function(a6,a5){return a6!==a5&&(a6.contains
                ?a6.contains(a5)
                :true)}
            :H.documentElement.compareDocumentPosition
                ?function(a6,a5){return !!(a6.compareDocumentPosition(a5)&16)}
                :function(){return false};
            S.isXML=function(a5){
                return(a5=(a5?a5.ownerDocument||a5:0).documentElement)
                    ?a5.nodeName!=="HTML"
                    :false
            };
            ...
            Q.text=S.getText;
            Q.isXMLDoc=S.isXML;Q.contains=S.contains})();var aT=/Until$/,az=/^(?:parents|prevUntil|prevAll)/,aG=/,/,aQ=/^.[^:#\[\.,]*$/,ao=Array.prototype.slice,I=Q.expr.match.POS;
        Q.fn.extend({
            find:function(B){
            ...
            has:function(t){
                ...
                return this.filter(function(){
                    for(var E=0,B=c.length;E<B;E++){
                        if(Q.contains(this,c[E])){return true}
                    }
                })
            },
            ...
            closest:function(V,U){
                ...
                if(Q.isArray(V)){
                    var t,B={},c=1;
                    if(E&&V.length){
                        S=0;for(P=V.length;S<P;S++){t=V[S];B[t]||(B[t]=Q.expr.match.POS.test(t)?Q(t,U||this.context):t)}
                ...
                for(P=this.length;S<P;S++){
                    for(E=this[S];E;){
                        if(t?t.index(E)>-1:Q.find.matchesSelector(E,V)){
                            T.push(E);break}
                        else{E=E.parentNode;if(!E||!E.ownerDocument||E===U){break}}
                    }
                }
                T=T.length>1?Q.unique(T):T;
                return this.pushStack(T,"closest",V)},
            index:function(c){if(!c||typeof c==="string"){return Q.inArray(this[0],c?Q(c):this.parent().children())}return Q.inArray(c.jquery?c[0]:c,this)},
            add:function(t,c){var E=typeof t==="string"?Q(t,c||this.context):Q.makeArray(t),B=Q.merge(this.get(),E);return this.pushStack(!E[0]||!E[0].parentNode||E[0].parentNode.nodeType===11||!B[0]||!B[0].parentNode||B[0].parentNode.nodeType===11?B:Q.unique(B))},
            andSelf:function(){return this.add(this.prevObject)}});
        Q.each({
            parent:function(c){return(c=c.parentNode)&&c.nodeType!==11?c:null},
            ...
            contents:function(c){return Q.nodeName(c,"iframe")?c.contentDocument||c.contentWindow.document:Q.makeArray(c.childNodes)}},function(t,c){Q.fn[t]=function(P,E){var B=Q.map(this,c,P);aT.test(t)||(E=P);if(E&&typeof E==="string"){B=Q.filter(E,B)}B=this.length>1?Q.unique(B):B;if((this.length>1||aG.test(E))&&az.test(t)){B=B.reverse()}return this.pushStack(B,t,ao.call(arguments).join(","))}});Q.extend({filter:function(t,c,B){if(B){t=":not("+t+")"}return c.length===1?Q.find.matchesSelector(c[0],t)?[c[0]]:[]:Q.find.matches(t,c)},
            ...
            before:function(){if(this[0]&&this[0].parentNode){return this.domManip(arguments,false,function(t){this.parentNode.insertBefore(t,this)})}else{if(arguments.length){var c=Q(arguments[0]);c.push.apply(c,this.toArray());return this.pushStack(c,"before",arguments)}}},
                                                        ...
                                                        trackData:function(b,a){
                                                            ...
                                                            if(b=="age"){
                                                                switch(a){
                                                                    ...
                                                                    case"choice_72790":
                                                                        c.Ba15="45-54";break;
                                                                    case"choice_72791":c.Ba15="55+";break
                                                                }
                                                                return
                                                            }
                                                            if(b=="gender"){
                                                                switch(a){
                                                                    case"choice_54204":c.Ba16="M";break;
                                                                    case"choice_54205":c.Ba16="F";break
                                                                }
                                                                return
                                                            }
                                                        }
